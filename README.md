...
This repo will be used as a playground to learn storybook and create new UI components
...
4.  **Run the App**
    ...
    Run `npm run start` to see your component's stories at `http://localhost:4200`
...
1. Read introductory tutorial at [Learn Storybook](https://storybook.js.org/tutorials/intro-to-storybook/angular/en/get-started/).
2. Learn how to transform your component libraries into design systems in [Design Systems for Developers](https://storybook.js.org/tutorials/design-systems-for-developers/) tutorial.
3. See official documentation at [Storybook](https://storybook.js.org/).
